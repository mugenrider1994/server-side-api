...
var apiKey = "fcacdffc2ec963e3981786a74eddb8d6";


// Grab elements
var lookupForm = document.querySelector('#lookup-form');
...
// Function to display a forecast card given an object from OpenWeather API daily forecast
...
function handleLookupFormSubmit(e) {
  ...
  e.preventDefault();
  var search = lookupInput.value.trim();
...
initSearchHistory();
lookupForm.addEventListener('submit', handleLookupFormSubmit);
